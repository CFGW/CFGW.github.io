  ...
  c.Plugins.AccordionPlugin = {
    ...
    _transformMarkup: function(c) {
      var g = c.$element[0],
        f =
        c.options,
        k = f.transitionDirection === "vertical";
    ...
    _attachBehavior: function(c) {
      var g = c.$element[0],
        f = c.options,
        k = 0,
        h = f.transitionDirection === "vertical",
        i = h ? "offsetWidth" : "offsetHeight",
        j = h ? "width" : "height",
        l = 0;
    ...
    if (-1 != a) {
      ...
      for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
        ...
        if ("generator" == d.getAttribute("name")) {
          "2015.2.0.352" != d.getAttribute("content") && Muse.assets.outOfDate.push("musewpdisclosure.js");
          break
        }
      }
    }
