...
(function(compId) {
  ...
  aLoader = [{
    ...
    load: "STRAIT%20CREWING%20door%20open%20wipSYMBOLTESTING_edge.js"
  }, {
    load: "STRAIT%20CREWING%20door%20open%20wipSYMBOLTESTING_edgeActions.js"
  }];
  ...
  dlContent = {
    dom: [{
      id: 'Text',
      type: 'text',
      rect: ['51px', '152px', '725px', '60px', 'auto', 'auto'],
      text: "This website requires a web browser with HTML5 compatability. Please update your browser to view the page correctly",
      align: "center",
      font: ['Arial, Helvetica, sans-serif', [24, ""], "rgba(77,77,77,1.00)", "normal", "none", ""]
    }, {
      id: 'Poster9',
      type: 'image',
      tag: 'img',
      rect: ['0', '0', '828px', '610px', 'auto', 'auto'],
