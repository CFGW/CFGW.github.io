  ...
  b.Widget.ContentSlideShow.filmstripTransitionPlugin = {
    ...
    attachBehavior: function(f) {
      var j = this,
        ...
        o = f.slides,
        r = o.$element,
        p = f.$clip ? f.$clip : f._findWidgetElements("." + k.clipClassName),
        n = f.$view ? f.$view : f._findWidgetElements("." + k.viewClassName),
        t = l(),
        q = p.height(),
        y = {
          left: 1,
    ...
    if (-1 != a) {
      ...
      for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
        ...
        if ("generator" == d.getAttribute("name")) {
          "2015.2.0.352" != d.getAttribute("content") && Muse.assets.outOfDate.push("webpro.js");
          break
        }
      }
    }
