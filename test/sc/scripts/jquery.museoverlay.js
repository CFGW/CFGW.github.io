...
(function(a) {
  a.fn.museOverlay = function(b) {
    ...
    return this.each(function() {
      ...
      var d = a("body"),
        g = a("<div></div>").appendTo(d).css({
          position: "absolute",
          top: 0,
          left: 0,
          zIndex: 100001
        }).hide(),
        f = a("<div></div>").append(c.$overlaySlice).appendTo(g).css({
          position: "absolute",
          top: 0,
          left: 0
        }),
        ...
        h = g.siblings("div"),
        k = a(window),
        i = k.data("scrollWrapper"),
        l, n, o = null,
        d = g.find("a, button, [tabindex], input, textarea, [contenteditable]"),
        p = d[0],
        q = d[d.length - 1],
        m = c.$elasticContent,
        s = m.length ? parseInt(m.css("padding-left")) + parseInt(m.css("padding-right")) + parseInt(m.css("border-left-width")) + parseInt(m.css("border-right-width")) : 0,
        t = m.length ? parseInt(m.css("padding-top")) +
        parseInt(m.css("padding-bottom")) + parseInt(m.css("border-top-width")) + parseInt(m.css("border-bottom-width")) : 0,
        C = c.$overlaySlice.outerWidth(),
        E = c.$overlaySlice.outerHeight(),
        v = {
          isOpen: !1,
          ...
          doLayout: function(a, b) {
            ...
            var f = a - s,
              d = b - t;
            m.length && m.hasClass("fullwidth") && (m.width(f), c.resizeSlidesFn && c.resizeSlidesFn(f, d));
            v.applyPageDimensions()
          },
          ...
          positionContent: function(a, b) {
            ...
            d = a - s;
            f = b - t;
            m.length && (m.width(d), m.hasClass("fullscreen") && m.height(f), c.resizeSlidesFn && c.resizeSlidesFn(d, f))
          }
        };
    ...
    if (-1 != a) {
      ...
      for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
        ...
        if ("generator" == d.getAttribute("name")) {
          "2015.2.0.352" != d.getAttribute("content") && Muse.assets.outOfDate.push("jquery.museoverlay.js");
          break
        }
      }
    }
