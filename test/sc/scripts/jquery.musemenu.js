  ...
  a.fn.museMenu = function() {
    return this.each(function() {
      ...
      if (!c.data("initialized")) {
        ...
        var q = a(),
          p = !1,
          n = c.find(".MenuItemContainer"),
          t = c.find(".MenuItem"),
          u = c.find(".SubMenu").add(t),
          y;
        ...
        n.on("mouseleave", function(b) {
          ...
          f.length > 0 && (y = setTimeout(function() {
            ...
            q = c.closest(".MenuItemContainer").data("$parentMenuItemContainer")
          }, 300))
        });
        ...
        t.each(function() {
          var b = a(this),
            ...
            m = b.closest(".MenuItemContainer"),
            n = m.parentsUntil(".MenuBar").filter(".MenuItemContainer").length === 0,
            o;
              ...
              if (n && d.length > 0) {
                ...
                if (g != "fixed") {
                  ...
                  var p = m.position(),
                    q = 0,
                    r = 0;
                  h && h != "auto" && (q = c.outerWidth() - p.left - b.width());
                  i && i != "auto" && (r = o);
                  k = parseInt(l.css("margin-left"));
                  if (l != c) {
                    var t = Muse.Utils.getStyleSheetRulesById(Muse.Utils.getPageStyleSheets(), l.attr("id"));
                    (t = t ? Muse.Utils.getRuleProperty(t, "left") : l.css("left")) && t.indexOf("%") != -1 && (k += c.offset().left -
                      l.offset().left)
                  }
                  a.css({
                    left: j,
                ...
                l && a && l.hasClass("scroll_effect") === !0 && a.cloneScrollEffectsFrom(l)
              }
              d.show();
              d.find(".SubMenu").hide()
            }).data("hideSubmenu", function() {
            var a = b.data("offsetContainer");
            a && a.hasClass("scroll_effect") === !0 && a.clearScrollEffects();
            d.hide()
    ...
    if (-1 != a) {
      ...
      for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
        ...
        if ("generator" == d.getAttribute("name")) {
          "2015.2.0.352" != d.getAttribute("content") && Muse.assets.outOfDate.push("jquery.musemenu.js");
          break
        }
      }
    }
